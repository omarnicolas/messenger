...
import java_api.messenger.model.Comment;
...
public class CommentService {
	...
	public Comment getComment(long messageId, long commentId) {
		ErrorMessage errorMessage = new ErrorMessage("Not found", 404, "http://omarnicolas.com"); // Not clean, better DataNotFoundExceptionMapper
